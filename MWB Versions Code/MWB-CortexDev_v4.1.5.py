        ...
        <div class="welcome-container">
            <div class="welcome-sidebar">
                ...
                <div class="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-relaxed">
                    Personalized System Optimization <br> Build v4.1.5 Stable
                </div>
            </div>
            ...
            <div class="welcome-content">
                ...
                <div id="w-stage-2" class="welcome-stage">
                    ...
                    <p class="text-gray-400 text-sm leading-relaxed mb-8">
                        ...
                        neutralize tracking services, and eliminate Windows 11 system clutter.
                    </p>
        ...
        <div id="page-about" class="page text-center">
            <div class="py-32 flex flex-col items-center">
                ...
                <div class="flex space-x-6">
                    <span class="bg-white/5 px-10 py-3 rounded-full text-[11px] font-black border border-white/10 uppercase tracking-widest">Build v4.1.5</span>
