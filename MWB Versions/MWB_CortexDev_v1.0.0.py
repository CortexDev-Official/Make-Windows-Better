...
class MWBApp(ctk.CTk):
    ...
    def show_about(self):
        ...
        ctk.CTkLabel(card, text="Pre-Alpha Build v1.0.0", font=self.font_main, text_color=CLR_TEXT_DIM).pack(pady=5)
        ctk.CTkLabel(card, text="Developed by CortexDev ", font=self.font_btn).pack(pady=20)
