...
class Api:
    ...
    def _log(self, msg, level="INFO"):
        """Copilot modification: Use json.dumps for safe escaping and XSS prevention"""
        try:
            payload = f"[{level}] {msg}"
            safe_js_arg = json.dumps(payload)
            webview.active_window().evaluate_js(f"addLog({safe_js_arg})")
        except:
            pass
    ...
    def run_install(self, uid):
        """Copilot modification: Verify UID and use ShellExecuteW for security"""
        def task():
            ...
            exe = "winget.exe"
            params = f'install --id {uid} -e --silent --accept-source-agreements --accept-package-agreements'
            
            try:
                # Anti-Flash: Changed 1 (SW_SHOWNORMAL) to SW_HIDE (0)
                ctypes.windll.shell32.ShellExecuteW(None, "runas", exe, params, None, SW_HIDE)
                ...
                self._log(f"Install failed for {uid}", "ERROR")
...
<body>
        ...
        <div class="welcome-container ray-trace-enabled">
            <div class="welcome-sidebar">
                ...
                <div class="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-relaxed">
                    Personalized System Optimization <br> Version 4.3.2
                </div>
            </div>
            ...
            <div class="welcome-content">
                ...
                <div id="w-stage-2" class="welcome-stage">
                    ...
                    <ul class="space-y-5 mb-10">
                        ...
                        <li class="flex items-center gap-4 text-xs font-bold text-gray-300">
                            <span class="w-2 h-2 bg-blue-500 rounded-full shadow-[0_0_10px_#3b82f6]"></span> 4.3.2 KERNEL BOOST
                        </li>
                    </ul>
        ...
        <div id="page-dashboard" class="page active">
            ...
            <div class="grid grid-cols-3 gap-8 mb-10">
                ...
                <div class="card border-orange-500/20 bg-orange-500/5 ray-trace-enabled">
                    ...
                    <h3 class="text-3xl font-black text-orange-500 italic">v4.3.2</h3>
        ...
        <div id="page-about" class="page text-center">
            <div class="py-32 flex flex-col items-center">
                ...
                <div class="flex space-x-6">
                    <span class="bg-white/5 px-10 py-3 rounded-full text-[11px] font-black border border-white/10 uppercase tracking-widest hover:bg-white/10 transition-colors cursor-default">Build v4.3.2</span>
    ...
    <script>
        ...
        window.addEventListener("pywebviewready", () => {
            ...
            showToast("MWB v4.3.2 Loaded", "success");
        });
    </script>
